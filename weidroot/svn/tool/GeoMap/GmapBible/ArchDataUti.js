var ArchDataUti=function(ArchInfo){
...
ArchDataUti.prototype.AddMore=function(ChronicleInfoArr){
...
ArchDataUti.prototype.sortByDate=function(sortType){
...
ArchDataUti.prototype.GetTable=function(){
...
ArchDataUti.prototype.getTableTH=function(){
        var str ="<tr><th>#</th>";
...
ArchDataUti.prototype.gen_data_for_gmap=function(){
    this.LatLngArr=[];
    this.NameArr=[];
    for(var i=0; i<this.ChronicleInfoArr.length; i++){
        var obj=this.ChronicleInfoArr[i];
...
ArchDataUti.prototype.FindCloset=function(latlng){
    var idx=-1;
...
ArchDataUti.prototype.distance=function(latlng1,latlng2){
...
ArchDataUti.prototype.gen_TimeFreq=function(nScale){
    //var nScale=200;
...
ArchDataUti.prototype.genFreqTable=function(){
...
ArchDataUti.prototype.GetFreqTable=function(jsparm){
    if(!jsparm.scale) jsparm.scale=200;
    this.gen_TimeFreq(jsparm.scale);
    return this.genFreqTable();
};

ArchDataUti.prototype.GenTimeDistanceArrForLatLng=function(slatlng){
    var TimeDistanceArr=[];
    for( var i=0;i<this.ChronicleInfoArr.length; i++){
        var obj=this.ChronicleInfoArr[i];
