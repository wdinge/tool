...
OLpct=new Array("83%","67%","83%","100%","117%","150%","200%","267%");
...
+'" /> ';if(close){closing+='<td align="right"><a href="online-atlas-north-america.htm" '+closeevent+'="'+cC+'"'+(o3_closefontclass?' class="'
