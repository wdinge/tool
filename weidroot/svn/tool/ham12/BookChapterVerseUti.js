...
var AudioBibleBooksNameChinese={
...
_1Sa:['#2F4F4F','Samuel1',             '撒母耳记上'],
_2Sa:['#2F4F4F','Samuel2',             '撒母耳记下'],
_1Ki:['#2F4F4F','Kings1',              '列王记上'],
_2Ki:['#2F4F4F','Kings2',              '列王记下'],
_1Ch:['#2F4F4F','Chronicles1',         '历代志上'],
_2Ch:['#2F4F4F','Chronicles2',         '历代志下'],
...
_1Co:['#002E63','Corinthians1',       '哥林多前书'],
_2Co:['#002E63','Corinthians2',       '哥林多后书'],
_Gal:['#002E63','Galatians',          '加拉太书'],
_Eph:['#002E63','Ephesians',          '以弗所书'],
_Phl:['#002E63','Philippians',        '腓立比书'],
_Col:['#002E63','Colossians',         '歌罗西书'],
_1Ts:['#002E63','Thessalonians1',     '帖撒罗尼迦前书'],
_2Ts:['#002E63','Thessalonians2',     '帖撒罗尼迦后书'],
_1Ti:['#002E63','Timothy1',           '提摩太前书'],
_2Ti:['#002E63','Timothy2',           '提摩太后书'],
_Tit:['#002E63','Titus',              '提多书'],
_Phm:['#002E63','Philemon',           '腓利门书'],
_Heb:['#003399','Hebrews',            '希伯来书'],
_Jas:['#003399','James',              '雅各书'],
_1Pe:['#003399','Peter1',             '彼得前书'],
_2Pe:['#003399','Peter2',             '彼得后书'],
_1Jn:['#003399','John1',              '约翰一书'],
_2Jn:['#003399','John2',              '约翰二书'],
_3Jn:['#003399','John3',              '约翰三书'],
...
BibleBookChapterVerse.prototype.FilterKey=function (key) {
    ...
    switch(this.iBookSwitchId){
        ...
        case 1://gospel, NT, OT, Moses, ONT etc. continued multi books.
            ...
            if(this.sKeyIdFlagStop===key){
                return 2;//to exit loop.
            }
            return this.iBooksRangeReadingInstructor;
        break;
        case 0://only one single book
            var i= key.indexOf(this.sBookId);
            if( i<0) return 0; //continue.
            return 1; //available loop. 
        break;
        default:
